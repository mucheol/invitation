...
export default function Greeting() {
  ...
  return (
    <section className="py-16 px-6 bg-white" aria-label="인사말">
      ...
      <div className="flex justify-center gap-8 mt-10">
        <a href={`tel:${groom.phone}`} className="flex flex-col items-center text-xs text-charcoal/60 gap-2" aria-label={`신랑 ${groom.name}에게 전화하기`}>
        ...
        <a href={`tel:${bride.phone}`} className="flex flex-col items-center text-xs text-charcoal/60 gap-2" aria-label={`신부 ${bride.name}에게 전화하기`}>
